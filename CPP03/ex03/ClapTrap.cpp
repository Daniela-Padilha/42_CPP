...
ClapTrap::ClapTrap() : _name("Not set"), _hit(10), _energy(10), _attack(0), _maxhint(10)
{
	std::cout << BGRN "ClapTrap default constructor called" RES << std::endl;
}

ClapTrap::ClapTrap(const std::string name) : _hit(10), _energy(10), _attack(0), _maxhint(10)
{
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	this->_energy--;
	if (this->_hit + amount >= this->_maxhint)
	{
		this->_hit = this->_maxhint;
